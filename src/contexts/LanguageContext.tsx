...
export const LanguageProvider = ({ children }: LanguageProviderProps) => {
  ...
  const translations: Record<Language, Record<string, string>> = {
    en: {
      ...
      'org.chairman': 'General Manager and Chairman of Board',
      'org.chairmanName': 'Rashid Bin Zaid Al-Muhayni',
      'org.viceChairman': 'Vice Chairman of Board',
    ...
    ar: {
      ...
      'org.chairman': 'المدير العام ورئيس مجلس الإدارة',
      'org.chairmanName': 'راشد بن زيد المهيني',
      'org.viceChairman': 'نائب رئيس مجلس الإدارة',
